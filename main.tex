...
\hline
\textbf{T} & \textbf{Entrega} & \multicolumn{16}{c|}{\textbf{Semanas}} \\
\hline
...
\hline
 7 & Módulo Odoo & & & & & & & & &x &x &x &x &x &x &x & \\
\hline
 8 & Capitulo final & & & & & & & & & & & & x&x & & & \\
\hline
 9 & Informe & & & & & & & & & & & & &x &x &x & x \\
\hline
\end{tabular}
