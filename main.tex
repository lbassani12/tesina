...
El objetivo general propuesto en la sección \ref{sec:Moti_O_G} se plantean los siguientes objetivos específicos. 
    ...
    \end{quote}
        ...
        El alcance de este objetivo es crear un módulo específico para que pueda ser integrado en la suite del framework denominado Odoo  fundation \footnote{https://www.odoo.com/es_ES} en su versión comunitaria de código abierto.
